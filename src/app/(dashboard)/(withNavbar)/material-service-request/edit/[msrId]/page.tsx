...
import { useUpdateMsr } from './@usecase';
...
const EditMsr = ({params}: {params: {msrId: string}}) => {
  const {
    groupCodes,
    uoms,
    router,
    ...
    disabledBtn,
    supplyer
  } = useUpdateMsr({msrId:params.msrId, })
  // console.log('product data', product)
  console.log('data product', convertToSelect(depts, ['id', 'dept_name']))
  return (
    <Grid
      container
      direction={'column'}
