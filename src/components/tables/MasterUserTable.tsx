...
export interface MasterUserTableColumnInterface {
  id: string,
  label: string,
}

export interface MasterUserTableInterface{
  fullname: string;
  username: string;
  phone: string;
  email: string;
...
const dummyColumn: MasterUserTableColumnInterface[] =[
  {
    id: 'fullname',
    label: 'FULL NAME',
  },
...
const dummyDatas: MasterUserTableInterface[] =[
  {
    fullname: 'Agus Wibowo',
    username: 'aguswibowo',
    phone: '9821382913218',
  ...
  return(
    ...
    >
      ...
      >
        ...
        <Box width={'160px'}>
          <CustomContainedButton label="Create User" isDisabled={false} onClick={onClickCreate} />
        </Box>
      </Grid>
